...
public class ItemFakeExternalDataSource implements ItemDataSource {
    ...
    public void getItems(Long categoryId, LoadItemsCallback callback) {
        ...
        switch (categoryId.intValue()) {
            case 0:
                items.add(new Item(null, categoryId, "Телевизор Samsung 50\"", "Разрешение 3840x2160 (4K UHD), Поддержка SMART TV", 300.0));
                items.add(new Item(null, categoryId, "Телевизор Sony 43\" ", "Разрешение 1920x1080,(Full HD),Поддержка SMART TV", 200.0));
                items.add(new Item(null, categoryId, "Телевизор LG 65\" 65UH850V LED UHD Smart 3D Black", "Разрешение 3840x2160 (4K UHD),Поддержка SMART TV,Поддержка 3D,", 132.0));
                break;
            case 1:
                items.add(new Item(null, categoryId, "Notebook Cloudbook Lenovo IdeaPad 100s", "11,6` 1366x768, Intel Atom Z3735F, RAM 2, SSD 32 ", 850.0));
                items.add(new Item(null, categoryId, "Notebook Dell Inspiron 15.6 Series-3552", "15.6` 1366x768 | Intel Pentium N3700 | RAM 4 | HDD 500 ", 930.0));
                items.add(new Item(null, categoryId, "Notebook Apple MacBook Air 13", "13,3` 1366x768 | Intel Core i5 5250U | RAM 8 | SSD 128", 220.0));
                break;
            case 2:
